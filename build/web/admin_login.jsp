<%-- 
    ...
    Created on : May 14, 2022, 9:58:02 AM
    Author     : adeeb
--%>
                            ...
                            <div class="card-body">
                                <form action="AdminLogInServlet" method="POST">
                                    <div class="form-group">
                                        ...
                                        <input name="username" required type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter username">
                                    </div>
                                    <div class="form-group">
